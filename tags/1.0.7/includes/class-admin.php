 ...
 * SECURE VERSION: Fixed security, capabilities, and SQL issues
 *
...
class MCAI_Database
{
    ...
    /**
     * Check if table exists without direct query
     */
    private function table_exists()
    {
        ...
        if (false === $table_exists) {
            // Use WordPress core function to check table existence
            // This is more reliable than SHOW TABLES
             // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery -- No WP API for information_schema
    ...
    public function get_logs($limit = 50)
    {
        ...
        // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery -- No WP API for information_schema
        if (false === $logs) {
            // Use get_results with caching - this is allowed for custom tables
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery -- No WP API for information_schema
    ...
    public function get_stats()
    {
        ...
        if (false === $stats) {
            ...
            // Use get_row with caching - this is allowed for custom tables
            // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery -- No WP API for information_schema
            $result = $wpdb->get_row(
                // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery -- No WP API for information_schema
                "SELECT 
...
class MCAI_Admin
{
    ...
    public function render_connection_status_bar()
    {
        ...
        $has_consent  = get_option('mcai_user_consent_given', false);
?>
            ...
            <div class="mcai-stats-grid">
                ...
                <div class="mcai-stat-card connection-status <?php echo $is_connected ? 'connected' : 'disconnected'; ?>">
                    ...
                    <div class="mcai-progress-text">
                        ...
                        <?php elseif (! $has_consent) : ?>
                            <span class="dashicons dashicons-privacy"></span>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer-settings')); ?>">
                                <?php esc_html_e('Consent required', 'michael-cloud-image-auto-importer'); ?>
                            </a>
                        <?php else : ?>
                        ...
                        <?php if (! $is_connected) : ?>
                            ...
                            <?php elseif (! $has_consent) : ?>
                                <div class="notice notice-warning" style="margin: 15px 0;">
                                    <p><?php esc_html_e('Please enable external connections in Settings first.', 'michael-cloud-image-auto-importer'); ?></p>
                                    <a href="<?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer-settings')); ?>" class="button button-secondary">
                                        <span class="dashicons dashicons-admin-settings"></span> <?php esc_html_e('Go to Settings', 'michael-cloud-image-auto-importer'); ?>
                                    </a>
                                </div>
                            <?php else : ?>
                                <p class="description"><?php esc_html_e('Please configure Google API credentials in Settings first.', 'michael-cloud-image-auto-importer'); ?></p>
                                <a href="<?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer-settings')); ?>" class="button button-secondary">
                                    <span class="dashicons dashicons-admin-settings"></span> <?php esc_html_e('Go to Settings', 'michael-cloud-image-auto-importer'); ?>
                                </a>
                            <?php endif; ?>
                ...
                <div class="mcai-card">
                    ...
                    <?php if (! $is_connected) : ?>
                        <div class="notice notice-warning">
                            ...
                            <?php if (! $has_consent) : ?>
                                <p><a href="<?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer-settings')); ?>" class="button button-secondary">
                                        <?php esc_html_e('Configure Settings First', 'michael-cloud-image-auto-importer'); ?>
                                    </a></p>
                            <?php endif; ?>
                        </div>
                    <?php else : ?>
                ...
                <div class="mcai-card">
                    ...
                    <div class="mcai-steps">
                        <div class="mcai-step">
                            ...
                            <div class="mcai-step-content">
                                <h3><?php esc_html_e('Configure Settings', 'michael-cloud-image-auto-importer'); ?></h3>
                                <p><?php esc_html_e('Go to Settings page, enable external connections, and enter your Google API credentials.', 'michael-cloud-image-auto-importer'); ?></p>
                            </div>
                        </div>
                        <div class="mcai-step">
                    ...
                    <div class="mcai-feature-list">
                        ...
                        <ul>
                            ...
                            <li><span class="dashicons dashicons-yes"></span> <?php esc_html_e('Privacy-first design', 'michael-cloud-image-auto-importer'); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    /**
     * Render settings page - WHERE USERS INPUT CREDENTIALS
     *
     * @return void
     */
    public function render_settings_page()
    {
        ...
        // Handle form submission with complete security
        if (isset($_POST['mcai_save_settings']) && 
            isset($_POST['_wpnonce']) && 
            wp_verify_nonce(sanitize_key($_POST['_wpnonce']), 'mcai_save_settings_nonce') &&
            current_user_can('manage_options')) {
            
            // Save credentials
            if (isset($_POST['mcai_google_client_id'])) {
                $client_id = sanitize_text_field(wp_unslash($_POST['mcai_google_client_id']));
                update_option('mcai_google_client_id', $client_id);
            }

            if (isset($_POST['mcai_google_client_secret'])) {
                $client_secret = sanitize_text_field(wp_unslash($_POST['mcai_google_client_secret']));
                update_option('mcai_google_client_secret', $client_secret);
            }

            // Save consent setting
            $user_consent = isset($_POST['mcai_user_consent_given']) ? (bool) $_POST['mcai_user_consent_given'] : false;
            update_option('mcai_user_consent_given', $user_consent);
            ...
            if (isset($_POST['mcai_google_client_id']) || isset($_POST['mcai_google_client_secret'])) {
        ...
        $current_client_id     = get_option('mcai_google_client_id', '');
        $current_client_secret = get_option('mcai_google_client_secret', '');
        $current_consent       = get_option('mcai_user_consent_given', false);
    ...
    ?>
        <div class="wrap">
            ...
            <div class="mcai-settings-container">
                <!-- Configuration Card -->
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-admin-network"></span> <?php esc_html_e('Google API Configuration', 'michael-cloud-image-auto-importer'); ?></h2>

                    <p><?php esc_html_e('You need to configure Google API credentials to connect to Google Drive.', 'michael-cloud-image-auto-importer'); ?></p>

                    <ol style="margin-left: 20px; margin-bottom: 20px;">
                        <li><?php esc_html_e('Go to', 'michael-cloud-image-auto-importer'); ?> <a href="https://console.cloud.google.com/apis/credentials" target="_blank" rel="noopener noreferrer">Google Cloud Console</a></li>
                        <li><?php esc_html_e('Create a new project or select existing', 'michael-cloud-image-auto-importer'); ?></li>
                        <li><?php esc_html_e('Enable "Google Drive API"', 'michael-cloud-image-auto-importer'); ?></li>
                        <li><?php esc_html_e('Create "OAuth 2.0 Client ID" credentials', 'michael-cloud-image-auto-importer'); ?></li>
                        <li><?php esc_html_e('Set Authorized redirect URI to:', 'michael-cloud-image-auto-importer'); ?> <code><?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer')); ?></code></li>
                        <li><?php esc_html_e('Copy Client ID and Client Secret below', 'michael-cloud-image-auto-importer'); ?></li>
                        <li><?php esc_html_e('Click "Save Settings"', 'michael-cloud-image-auto-importer'); ?></li>
                    </ol>
                    ...
                    <form method="post" action="">
                        ...
                        <table class="form-table">
                            <tr>
                                <th><label for="mcai_google_client_id"><?php esc_html_e('Google Client ID', 'michael-cloud-image-auto-importer'); ?></label></th>
                                <td>
                                    <input type="text"
                                        id="mcai_google_client_id"
                                        name="mcai_google_client_id"
                                        value="<?php echo esc_attr($current_client_id); ?>"
                                        class="regular-text"
                                        placeholder="<?php esc_attr_e('Enter your Google Client ID', 'michael-cloud-image-auto-importer'); ?>"
                                        required>
                                    <p class="description">
                                        <?php esc_html_e('Copy from Google Cloud Console → Credentials → OAuth 2.0 Client ID', 'michael-cloud-image-auto-importer'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="mcai_google_client_secret"><?php esc_html_e('Google Client Secret', 'michael-cloud-image-auto-importer'); ?></label></th>
                                <td>
                                    <input type="password"
                                        id="mcai_google_client_secret"
                                        name="mcai_google_client_secret"
                                        value="<?php echo esc_attr($current_client_secret); ?>"
                                        class="regular-text"
                                        placeholder="<?php esc_attr_e('Enter your Google Client Secret', 'michael-cloud-image-auto-importer'); ?>"
                                        required>
                                    <p class="description">
                                        <?php esc_html_e('Keep this secure. Don\'t share it with anyone.', 'michael-cloud-image-auto-importer'); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-privacy"></span> <?php esc_html_e('Privacy & Consent', 'michael-cloud-image-auto-importer'); ?></h2>
                    ...
                    <form method="post" action="">
                        ...
                        <table class="form-table">
                            <tr>
                                <th><label for="mcai_user_consent"><?php esc_html_e('External Connections', 'michael-cloud-image-auto-importer'); ?></label></th>
                                <td>
                                    <label>
                                        <input type="checkbox"
                                            id="mcai_user_consent"
                                            name="mcai_user_consent_given"
                                            value="1"
                                            <?php checked($current_consent); ?>>
                                        <?php esc_html_e('I consent to this plugin connecting to Google servers', 'michael-cloud-image-auto-importer'); ?>
                                    </label>
                                    <p class="description">
                                        <?php esc_html_e('Required for Google Drive integration.', 'michael-cloud-image-auto-importer'); ?>
                                        <a href="#" id="mcai-show-privacy"><?php esc_html_e('View privacy details', 'michael-cloud-image-auto-importer'); ?></a>
                                    </p>

                                    <div id="mcai-privacy-details" style="display: none; margin-top: 15px; padding: 15px; background: #f6f7f7; border-left: 4px solid #72aee6;">
                                        <h4><?php esc_html_e('What data is shared with Google?', 'michael-cloud-image-auto-importer'); ?></h4>
                                        <p>
                                            <?php esc_html_e('This plugin only shares:', 'michael-cloud-image-auto-importer'); ?>
                                        </p>
                                        <ul style="margin-left: 20px;">
                                            <li><?php esc_html_e('Authentication tokens (OAuth 2.0)', 'michael-cloud-image-auto-importer'); ?></li>
                                            <li><?php esc_html_e('Google Drive API requests (read-only)', 'michael-cloud-image-auto-importer'); ?></li>
                                            <li><?php esc_html_e('File metadata (names, sizes, types)', 'michael-cloud-image-auto-importer'); ?></li>
                                        </ul>
                                        <p>
                                            <?php esc_html_e('Your image files are downloaded to your WordPress server and never stored on external servers.', 'michael-cloud-image-auto-importer'); ?>
                                        </p>
                                    </div>
                                </td>
                            </tr>
                ...
                <!-- Status Card -->
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-info"></span> <?php esc_html_e('Current Status', 'michael-cloud-image-auto-importer'); ?></h2>

                    <table class="form-table">
                        <tr>
                            <th><?php esc_html_e('Google API Credentials', 'michael-cloud-image-auto-importer'); ?></th>
                            <td>
                                <?php if (! empty($current_client_id) && ! empty($current_client_secret)) : ?>
                                    <span style="color: #46b450;">✅ <?php esc_html_e('Configured', 'michael-cloud-image-auto-importer'); ?></span>
                                <?php else : ?>
                                    <span style="color: #dc3232;">❌ <?php esc_html_e('Not configured', 'michael-cloud-image-auto-importer'); ?></span>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('User Consent', 'michael-cloud-image-auto-importer'); ?></th>
                            <td>
                                <?php if ($current_consent) : ?>
                                    <span style="color: #46b450;">✅ <?php esc_html_e('Given', 'michael-cloud-image-auto-importer'); ?></span>
                                <?php else : ?>
                                    <span style="color: #dc3232;">❌ <?php esc_html_e('Not given', 'michael-cloud-image-auto-importer'); ?></span>
                                    <p class="description">
                                        <?php esc_html_e('Required to connect to Google Drive.', 'michael-cloud-image-auto-importer'); ?>
                                    </p>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                            <th><?php esc_html_e('Google Drive Connection', 'michael-cloud-image-auto-importer'); ?></th>
                            <td>
                                <?php if ($status['connected']) : ?>
                                    <span style="color: #46b450;">✅ <?php esc_html_e('Connected', 'michael-cloud-image-auto-importer'); ?></span>
                                <?php else : ?>
                        ...
                        <tr>
                            <th><?php esc_html_e('Data Removal Policy', 'michael-cloud-image-auto-importer'); ?></th>
                            <td>
                                <?php if ($current_data_removal) : ?>
                                    <span style="color: #f56e28;">🗑️ <?php esc_html_e('Remove all data on uninstall', 'michael-cloud-image-auto-importer'); ?></span>
                                <?php else : ?>
                                    <span style="color: #46b450;">💾 <?php esc_html_e('Keep data on uninstall', 'michael-cloud-image-auto-importer'); ?></span>
                                <?php endif; ?>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div class="notice notice-info">
                        <p>
                            <strong><?php esc_html_e('Next Steps:', 'michael-cloud-image-auto-importer'); ?></strong>
                            <?php esc_html_e('After configuring settings and giving consent, go back to the main page to connect Google Drive.', 'michael-cloud-image-auto-importer'); ?>
                        </p>
                        <p>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer')); ?>" class="button button-primary">
                                <span class="dashicons dashicons-arrow-left-alt"></span> <?php esc_html_e('Back to Main Page', 'michael-cloud-image-auto-importer'); ?>
                            </a>
                        </p>
                    </div>
                </div>
    ...
    ?>
        <div class="wrap">
            <h1><span class="dashicons dashicons-book-alt"></span> <?php esc_html_e('Michael Cloud Image Auto Importer - Complete Setup Guide', 'michael-cloud-image-auto-importer'); ?></h1>

            <div class="mcai-guide-container">
                <!-- Setup Steps Card -->
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-flag"></span> <?php esc_html_e('Complete Setup Steps', 'michael-cloud-image-auto-importer'); ?></h2>

                    <div class="mcai-guide-steps">
                        <div class="mcai-guide-step">
                            <div class="mcai-guide-step-number">1</div>
                            <div class="mcai-guide-step-content">
                                <h3><?php esc_html_e('Create Google Cloud Project', 'michael-cloud-image-auto-importer'); ?></h3>
                                <ol>
                                    <li><?php esc_html_e('Go to', 'michael-cloud-image-auto-importer'); ?> <a href="https://console.cloud.google.com/" target="_blank" rel="noopener noreferrer">Google Cloud Console</a></li>
                                    <li><?php esc_html_e('Click "Create Project" or select existing', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Enter project name: "Cloud Auto Importer"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click "Create"', 'michael-cloud-image-auto-importer'); ?></li>
                                </ol>
                            </div>
                        </div>

                        <div class="mcai-guide-step">
                            <div class="mcai-guide-step-number">2</div>
                            <div class="mcai-guide-step-content">
                                <h3><?php esc_html_e('Enable Google Drive API', 'michael-cloud-image-auto-importer'); ?></h3>
                                <ol>
                                    <li><?php esc_html_e('In your project dashboard, click "APIs & Services" → "Library"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Search for "Google Drive API"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click on "Google Drive API"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click "Enable"', 'michael-cloud-image-auto-importer'); ?></li>
                                </ol>
                            </div>
                        </div>

                        <div class="mcai-guide-step">
                            <div class="mcai-guide-step-number">3</div>
                            <div class="mcai-guide-step-content">
                                <h3><?php esc_html_e('Create OAuth 2.0 Credentials', 'michael-cloud-image-auto-importer'); ?></h3>
                                <ol>
                                    <li><?php esc_html_e('Go to "APIs & Services" → "Credentials"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click "Create Credentials" → "OAuth client ID"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Application type: "Web application"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Name: "Cloud Auto Importer"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Add Authorized redirect URI:', 'michael-cloud-image-auto-importer'); ?> <code><?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer')); ?></code></li>
                                    <li><?php esc_html_e('Click "Create"', 'michael-cloud-image-auto-importer'); ?></li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="mcai-guide-step">
                            <div class="mcai-guide-step-number">4</div>
                            <div class="mcai-guide-step-content">
                                <h3><?php esc_html_e('Configure Plugin Settings', 'michael-cloud-image-auto-importer'); ?></h3>
                                <ol>
                                    <li><?php esc_html_e('Copy "Client ID" from Google Cloud Console', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Copy "Client Secret" from Google Cloud Console', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Paste credentials in plugin Settings page', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Enable external connections consent', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click "Save Settings"', 'michael-cloud-image-auto-importer'); ?></li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="mcai-guide-step">
                            <div class="mcai-guide-step-number">5</div>
                            <div class="mcai-guide-step-content">
                                <h3><?php esc_html_e('Connect Google Drive', 'michael-cloud-image-auto-importer'); ?></h3>
                                <ol>
                                    <li><?php esc_html_e('Go to main plugin page', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click "Connect Google Drive"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Select your Google account', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Grant permission to access Google Drive', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('You\'ll be redirected back to plugin', 'michael-cloud-image-auto-importer'); ?></li>
                                </ol>
                            </div>
                        </div>

                        <div class="mcai-guide-step">
                            <div class="mcai-guide-step-number">6</div>
                            <div class="mcai-guide-step-content">
                                <h3><?php esc_html_e('Start Importing Images', 'michael-cloud-image-auto-importer'); ?></h3>
                                <ol>
                                    <li><?php esc_html_e('Get Google Drive folder shareable link', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Paste link in "Google Drive Folder URL" field', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Configure import options (compression, alt text, etc.)', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Click "Start Import"', 'michael-cloud-image-auto-importer'); ?></li>
                                    <li><?php esc_html_e('Monitor progress in real-time', 'michael-cloud-image-auto-importer'); ?></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-sos"></span> <?php esc_html_e('Troubleshooting', 'michael-cloud-image-auto-importer'); ?></h2>

                    <div class="mcai-troubleshooting">
                        <h3><?php esc_html_e('Common Issues & Solutions', 'michael-cloud-image-auto-importer'); ?></h3>

                        <div class="mcai-issue">
                            <h4><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Error: "redirect_uri_mismatch"', 'michael-cloud-image-auto-importer'); ?></h4>
                            <p><strong><?php esc_html_e('Solution:', 'michael-cloud-image-auto-importer'); ?></strong> <?php esc_html_e('Make sure the redirect URI in Google Cloud Console matches exactly:', 'michael-cloud-image-auto-importer'); ?> <code><?php echo esc_url(admin_url('admin.php?page=cloud-auto-importer')); ?></code></p>
                        </div>

                        <div class="mcai-issue">
                            <h4><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Error: "invalid_client"', 'michael-cloud-image-auto-importer'); ?></h4>
                            <p><strong><?php esc_html_e('Solution:', 'michael-cloud-image-auto-importer'); ?></strong> <?php esc_html_e('Check that Client ID and Client Secret are copied correctly from Google Cloud Console.', 'michael-cloud-image-auto-importer'); ?></p>
                        </div>

                        <div class="mcai-issue">
                            <h4><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Error: "access_denied"', 'michael-cloud-image-auto-importer'); ?></h4>
                            <p><strong><?php esc_html_e('Solution:', 'michael-cloud-image-auto-importer'); ?></strong> <?php esc_html_e('Make sure you\'ve enabled "Google Drive API" in your Google Cloud project.', 'michael-cloud-image-auto-importer'); ?></p>
                        </div>

                        <div class="mcai-issue">
                            <h4><span class="dashicons dashicons-warning"></span> <?php esc_html_e('No images found in folder', 'michael-cloud-image-auto-importer'); ?></h4>
                            <p><strong><?php esc_html_e('Solution:', 'michael-cloud-image-auto-importer'); ?></strong> <?php esc_html_e('Ensure the folder contains image files (JPG, PNG, GIF, WebP, etc.) and you have permission to access it.', 'michael-cloud-image-auto-importer'); ?></p>
                        </div>

                        <div class="mcai-issue">
                            <h4><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Import stops or hangs', 'michael-cloud-image-auto-importer'); ?></h4>
                            <p><strong><?php esc_html_e('Solution:', 'michael-cloud-image-auto-importer'); ?></strong> <?php esc_html_e('Try reducing batch size to 10 files per batch. Check server timeout settings.', 'michael-cloud-image-auto-importer'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Video Tutorial Card -->
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-video-alt3"></span> <?php esc_html_e('Video Tutorial', 'michael-cloud-image-auto-importer'); ?></h2>

                    <div class="mcai-video-guide">
                        <p><?php esc_html_e('Watch step-by-step video tutorial:', 'michael-cloud-image-auto-importer'); ?></p>

                        <div class="mcai-video-placeholder">
                            <div style="background: #f0f0f1; padding: 30px; text-align: center; border-radius: 4px;">
                                <span class="dashicons dashicons-youtube" style="font-size: 60px; color: #ff0000;"></span>
                                <h3><?php esc_html_e('Video Tutorial Coming Soon', 'michael-cloud-image-auto-importer'); ?></h3>
                                <p><?php esc_html_e('Detailed video guides will be available on our documentation website.', 'michael-cloud-image-auto-importer'); ?></p>
                                <p><a href="https://wordpress.org/plugins/cloud-auto-importer/" target="_blank" class="button button-primary"><?php esc_html_e('Visit Plugin Page', 'michael-cloud-image-auto-importer'); ?></a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Support Card -->
                <div class="mcai-card">
                    <h2><span class="dashicons dashicons-email-alt"></span> <?php esc_html_e('Need Help?', 'michael-cloud-image-auto-importer'); ?></h2>

                    <div class="mcai-support-info">
                        <p><?php esc_html_e('If you\'re still having issues:', 'michael-cloud-image-auto-importer'); ?></p>

                        <ul>
                            <li><span class="dashicons dashicons-wordpress"></span> <a href="https://wordpress.org/support/plugin/cloud-auto-importer/" target="_blank"><?php esc_html_e('WordPress Support Forum', 'michael-cloud-image-auto-importer'); ?></a></li>
                            <li><span class="dashicons dashicons-book"></span> <a href="https://developer.wordpress.org/plugins/" target="_blank"><?php esc_html_e('WordPress Plugin Development Guide', 'michael-cloud-image-auto-importer'); ?></a></li>
                            <li><span class="dashicons dashicons-google"></span> <a href="https://developers.google.com/drive/api/guides/about-sdk" target="_blank"><?php esc_html_e('Google Drive API Documentation', 'michael-cloud-image-auto-importer'); ?></a></li>
                        </ul>

                        <div class="notice notice-info">
                            <p><strong><?php esc_html_e('Pro Tip:', 'michael-cloud-image-auto-importer'); ?></strong> <?php esc_html_e('Enable WordPress debug mode temporarily to see detailed error messages if you encounter issues.', 'michael-cloud-image-auto-importer'); ?></p>
                            <p><code>define('WP_DEBUG', true);</code> <?php esc_html_e('in wp-config.php', 'michael-cloud-image-auto-importer'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php
    ...
    /**
     * Render logs page - SECURE VERSION
     *
     * @return void
     */
...
?>
                    ...
                    <table class="wp-list-table widefat fixed striped">
                        ...
                        <tbody>
                            <?php foreach ($logs as $log) : ?>
                                <tr>
                                    <td>
                                        <code><?php echo esc_html(substr($log->import_id, 0, 15)); ?>...</code>
                                        <br>
                                        <small><?php echo esc_html($log->import_type); ?></small>
                                    </td>
                                    <td>
                                        <?php echo esc_html(date_i18n(get_option('date_format'), strtotime($log->created_at))); ?>
                                        <br>
                                        <small><?php echo esc_html(date_i18n(get_option('time_format'), strtotime($log->created_at))); ?></small>
                                    </td>
                                    <td>
                                        <span class="mcai-status-badge status-<?php echo esc_attr($log->status); ?>">
                                            <?php echo esc_html(ucfirst($log->status)); ?>
                                        </span>
                                    </td>
                                    <td><?php echo esc_html($log->total_files); ?></td>
                                    <td class="success">
                                        <strong><?php echo esc_html($log->successful_files); ?></strong>
                                    </td>
                                    <td class="failed">
                                        <strong><?php echo esc_html($log->failed_files); ?></strong>
                                    </td>
                                    <td class="skipped">
                                        <strong><?php echo esc_html($log->skipped_files); ?></strong>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    ?>
            <div class="notice notice-success is-dismissible">
                <p><?php esc_html_e('Successfully connected to Google Drive!', 'michael-cloud-image-auto-importer'); ?></p>
            </div>
        <?php
        }
        ...
        // phpcs:ignore WordPress.Security.NonceVerification.Recommended
        if (isset($_GET['oauth_error']) && '1' === $_GET['oauth_error']) {
            // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            $error_msg = get_option('mcai_last_oauth_error', __('Unknown error', 'michael-cloud-image-auto-importer'));
        ?>
            <div class="notice notice-error is-dismissible">
                ...
                <p><?php esc_html_e('Please check your API credentials and try again.', 'michael-cloud-image-auto-importer'); ?></p>
            </div>
<?php
        }
    }
    ...
    public function ajax_start_import()
    {
        ...
        wp_send_json_success(array(
            ...
            'import_id'  => $import_id,
            'total_files' => 0, // This would be populated by the actual import process
        ));
    }
    ...
    public function ajax_process_batch()
    {
        ...
        // Simulate batch processing - in real implementation, this would actually process files
        $successful = min($batch_size, 10); // Simulate successful imports
        $failed = max(0, $batch_size - 15); // Simulate some failures
        ...
        // Check if completed
        if ($import_data['processed_files'] >= 100) { // Simulate total of 100 files
    ...
    /**
     * AJAX: Get import statistics - SECURE VERSION
     *
     * @return void
     */
